...
function LoginPage() {
  ...
  return (
    <div className="flex justify-center items-center min-w-full min-h-screen bg-gradient-to-tr from-zinc-700 to-zinc-900">
        <img src={Image} alt="" className="absolute top-0 left-0 w-screen h-screen object-cover z-10" />
        {/* big screen login page */}
        
        <div className="relative hidden lg:flex justify-center items-center w-[1000px] h-[600px] bg-gray-100 rounded-[50px] overflow-hidden z-30">
          ...
          <div className={`right absolute top-0 right-0 flex justify-center items-center w-1/2 h-full ${status==="right" ? "bg-gradient-to-tl from-pink-600 to-rose-900 rounded-l-[100px]" : "bg-gradient-to-tr from-sky-700 to-cyan-800 rounded-r-[100px] right-full translate-x-full"} transition-all duration-1000`}>
        ...
        {/* mobile login page */}
          <div className="absolute  top-0 left-0 w-screen h-screen z-20 backdrop-blur-[12px]" />
          <form onSubmit={submitHandler} className="lg:hidden flex flex-col justify-center items-center gap-y-5 text-zinc-800 w-full sm720:w-4/5 max-w-[400px] p-10 mx-8 sm400:mx-14 bg-white/70 border border-white backdrop-blur-xl rounded-2xl z-30">
